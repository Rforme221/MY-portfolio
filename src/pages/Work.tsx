      ...
      <section className="section bg-brand-bg text-brand-dark border-b border-brand-border/30 relative z-20">
        <div className="section__inner w-full">
          ...
          {isLoading ? (
            ...
            <div className="relative flex flex-col gap-[clamp(4rem,8vw,12rem)] pb-[clamp(2rem,5vw,6rem)] animate-fadeIn" id="work-skeleton-stack">
              {[...Array(3)].map((_, idx) => {
                const zIndexValue = idx + 10;
                return (
                  <div 
                    key={idx}
                    className="sticky top-[clamp(5.5rem,12vh,9rem)] w-full min-h-[460px] sm:min-h-[clamp(450px,78vh,850px)] rounded-[clamp(1.25rem,3vw,3rem)] overflow-hidden bg-gradient-to-b from-slate-100 to-slate-50 border border-slate-200/50 p-5 sm:p-[clamp(1.5rem,4vw,4rem)] flex flex-col justify-between"
                  ...
                  >
                    ...
                    <div className="relative z-20 self-start w-full max-w-[clamp(18rem,34vw,26rem)] backdrop-blur-xl bg-white/70 border border-slate-200 p-4 sm:p-[clamp(1rem,2.2vw,2.5rem)] rounded-2xl sm:rounded-[clamp(0.75rem,2vw,1.5rem)] flex flex-col gap-4 text-left shadow-md mt-4 sm:mt-0">
            ...
            <div className="relative flex flex-col gap-[clamp(4rem,8vw,12rem)] pb-[clamp(2rem,5vw,6rem)] animate-fadeIn" id="work-content-stack">
